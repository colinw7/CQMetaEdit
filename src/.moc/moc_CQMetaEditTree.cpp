...
QT_INIT_METAOBJECT const QMetaObject CQMetaEditTree::staticMetaObject = { {
    QMetaObject::SuperData::link<CQTreeView::staticMetaObject>(),
    qt_meta_stringdata_CQMetaEditTree.data,
    qt_meta_data_CQMetaEditTree,
    qt_static_metacall,
    nullptr,
    nullptr
} };
